...
img  = ImageTk.PhotoImage(Image.open('maingameforest.png'))
c.create_image(700,320,image=img)
...
# Appearing in the interval of 4ms
egg_interval = 4000

# Difficulty_factor will increase the hardness of the game
difficulty_factor = 0.95

# setting catcher color,width,height and position
catcher_color = 'blue'
catcher_width = 100
catcher_height = 100
catcher_start_x = canvas_width / 2 - catcher_width / 2
catcher_start_y = canvas_height -catcher_height - 100
...
## GAME SOUND ##
pygame.init()
pygame.mixer.music.load('gameplay_sound.mp3')
